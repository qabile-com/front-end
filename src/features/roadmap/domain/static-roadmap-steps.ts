...
export const STATIC_ROADMAP_STEPS: StaticRoadmapStep[] = [
  ...
  // },
  {
    ...
    description:
      'هیچ ققنوسی در سکوت متولد نمی‌شود. وارد انجمن شو، خودت را معرفی کن و اولین پستت را منتشر کن تا هم‌قبیله‌ای‌ها تو را بشناسند.',
    xp: 70,
    type: 'تعامل اجتماعی',
    status: 'next',
    kind: 'social-compose',
    ...
    instructions: [
      {
        title: 'در موبایل',
        desktop:
          'از منوی پایین وارد انجمن شو و دکمه نارنجی ️ پایینِ سمت چپ صفحه استفاده کن و اولین پستت را بنویس.',
        mobile:
          'از منوی پایین وارد انجمن شو و دکمه نارنجی ️ پایینِ سمت چپ صفحه استفاده کن و اولین پستت را بنویس.',
      },
      {
        title: 'در دسکتاپ',
        desktop:
          'در ساید بار سمت راست وارد انجمن شو و از دکمه نارنجی پایین سمت چپ صفحه استفاده کن، متن پستت را داخل کادر بنویس و روی دکمه «انتشار» کلیک کن.',
        mobile:
          'در ساید بار سمت راست وارد انجمن شو و از دکمه نارنجی پایین سمت چپ صفحه استفاده کن، متن پستت را داخل کادر بنویس و روی دکمه «انتشار» کلیک کن.',
      },
    ],
    imageSlots: [
      { src: ROADMAP_ASSET_PATHS.step2First, alt: 'راهنمای ایجاد پست در انجمن' },
      {
    ...
    instructions: [
      {
        title: 'در موبایل',
        mobile:
          'از منوی پایین وارد انجمن شو و پست دلخواهت رو انتخاب کن و از طریق قلب لایکش کن یا از طریق آیکون نظر پیامت رو برای نویسنده بنویس.',
        desktop:
          'از منوی پایین وارد انجمن شو و پست دلخواهت رو انتخاب کن و از طریق قلب لایکش کن یا از طریق آیکون نظر پیامت رو برای نویسنده بنویس.',
      },
      {
        title: 'در دسکتاپ',
        mobile:
          'در ساید بار سمت راست وارد انجمن شو و و پست دلخواهت رو انتخاب کن و از طریق قلب لایکش کن یا از طریق آیکون نظر پیامت رو برای نویسنده بنویس.',
        desktop:
          'در ساید بار سمت راست وارد انجمن شو و و پست دلخواهت رو انتخاب کن و از طریق قلب لایکش کن یا از طریق آیکون نظر پیامت رو برای نویسنده بنویس.',
      },
    ],
...
نوسان قند خون؛ دشمن تمرکز`,
  ...
  },
  {
    ...
    category: 'تعامل اجتماعی',
    description:
      'رشد، تنهایی اتفاق نمی‌افتد. وارد انجمن شو، پروفایل ۵ نفر که احساس می‌کنی هم‌مسیرت هستند را باز کن و روی دکمه «فالو کردن» بزن. هر مسیر بزرگ، از یک همراه خوب شروع می‌شود.',
    xp: 150,
    type: 'تعامل اجتماعی',
    status: 'next',
    kind: 'social-connect',
    ...
    instructions: [
      {
        title: 'در موبایل',
        mobile:
          'از منوی پایین وارد انجمن شو و فرد دلخواهت رو انتخاب کن و روی اسم یا پروفایلش کلیک کن و روی دکمه فالو کردن بزن.',
        desktop:
          'از منوی پایین وارد انجمن شو و فرد دلخواهت رو انتخاب کن و روی اسم یا پروفایلش کلیک کن و روی دکمه فالو کردن بزن.',
      },
      {
        title: 'در دسکتاپ',
        mobile:
          'در ساید بار سمت راست وارد انجمن شو و فرد دلخواهت رو انتخاب کن و روی اسم یا پروفایلش کلیک کن و روی دکمه فالو کردن بزن.',
        desktop:
          'در ساید بار سمت راست وارد انجمن شو و فرد دلخواهت رو انتخاب کن و روی اسم یا پروفایلش کلیک کن و روی دکمه فالو کردن بزن.',
      },
    ],
