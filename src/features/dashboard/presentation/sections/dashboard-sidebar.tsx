...
export function DashboardSidebar({ active, onChange }: SidebarProps) {
  ...
  return (
    <aside className="border-hair fixed inset-y-0 start-0 z-50 flex w-[260px] shrink-0 flex-col border-e px-[18px] py-7 [backdrop-filter:blur(24px)] [background:rgba(8,5,2,.92)] max-[900px]:w-[220px]">
