...
import { LEADERBOARD, PODIUM } from '@/features/dashboard/domain/dashboard.data';
          ...
          return (
            <div
              ...
              className={cn(
                ...
                first &&
                  'border-[rgba(243,186,99,.36)] [background:radial-gradient(120%_120%_at_50%_0%,rgba(243,186,99,.12),var(--glass))]',
              )}
            >
              {first && (
                <Icon
              ...
              <span
                className={cn(
                  'absolute start-3 top-3 grid size-[26px] place-items-center rounded-lg text-xs font-extrabold',
                  first
                    ? 'text-[#1a0a00] [background:var(--fire-grad)]'
                    : 'border-hair text-ink-3 border [background:var(--glass-2)]',
                )}
              >
        ...
        <table className="w-full">
          <thead>
            <tr className="text-ink-3 text-[12px] uppercase">
              ...
              <th className="px-5 py-3 text-start font-bold">زنجیره</th>
            </tr>
          </thead>
          <tbody>
            {LEADERBOARD.map((row) => (
              <tr
                ...
                className={cn(
                  'transition-colors',
                  row.isYou
                    ? '[background:linear-gradient(135deg,rgba(255,98,0,.12),rgba(243,186,99,.06))]'
              ...
              >
                ...
                <td className="text-ember px-5 py-3">
